...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/gzl_demo?useUnicode=true&useSSL=false&characterEncoding=utf8");
...
//        pc.setModuleName(scanner("模块名"));
        pc.setParent("com.wang.gongzuoliu");
...
//        strategy.setSuperEntityColumns("remark");
        ...
        mpg.execute();
        System.out.println("完事啦！！请在mapper上加注解；更改Mapper包下的NUll目录名");
    }
}
